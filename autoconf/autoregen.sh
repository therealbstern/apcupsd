...
./configure --enable-powerflute --enable-cgi --enable-nls --with-included-gettext --with-catgets --with-libwrap=yes --enable-usb --enable-snmp --enable-net --enable-test --enable-pthreads
