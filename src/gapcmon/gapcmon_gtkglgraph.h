/* gapcmon_gtkglgraph.h    serial-0057-3 ***************************************
 *
...
extern void     gtk_glgraph_set_drawn (GtkGLGraph * glg,
                                       const GtkGLGDraw drawn);
extern void     gtk_glgraph_set_title (GtkGLGraph * glg,
                                       const gchar * const title);
