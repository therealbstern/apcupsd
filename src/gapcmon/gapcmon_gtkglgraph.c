                                            ...
                                            GdkEventButton * event)
{
  if (event->button == 1)
  {
    ...
    glg->cx1 =
            CLAMP (glg->cx1, glg->axes[GTKGLG_AXIS_X].min,
                   glg->axes[GTKGLG_AXIS_X].max);
    glg->cy1 =
            CLAMP (glg->cy1, glg->axes[GTKGLG_AXIS_Y].min,
                   glg->axes[GTKGLG_AXIS_Y].max);
                                              ...
                                              GdkEventButton * event)
{
  if (event->button == 1)
  {
    ...
    glg->cx2 =
            CLAMP (glg->cx2, glg->axes[GTKGLG_AXIS_X].min,
                   glg->axes[GTKGLG_AXIS_X].max);
    glg->cy2 =
            CLAMP (glg->cy2, glg->axes[GTKGLG_AXIS_Y].min,
                   glg->axes[GTKGLG_AXIS_Y].max);
...
static void gtk_glgraph_layout_calculate_offsets (GtkGLGraph * glg)
{
  ...
  if (drawn & GTKGLG_D_LEGEND)
  {
    ...
    {
      glg->right +=
              BORDER + glg->legend_text_width + 3 * LEGEND_MARGIN +
              LEGEND_LINE_LENGTH;
      glg->z_left +=
              BORDER + glg->legend_text_width + 3 * LEGEND_MARGIN +
              LEGEND_LINE_LENGTH;
