/*
 * This C file has been generated by smidump 0.3.1.
 * It is intended to be used with the NET-SNMP library.
 *
 * This C file is derived from the PowerNet-MIB module.
 *
 * $Id: powernet-mib-mgr.c,v 1.2 2003-07-12 11:39:01 kerns Exp $
 */
...
static oid upsBasicControlConserveBattery[] = {1, 3, 6, 1, 4, 1, 318, 1, 1, 1, 6, 1, 1};
...
int powernet_mib_mgr_get_upsAdvOutput(struct snmp_session *s, upsAdvOutput_t **upsAdvOutput)
{
    ...
    *upsAdvOutput = (upsAdvOutput_t *) malloc(sizeof(upsAdvOutput_t));
	...
	if (vars->name_length > sizeof(upsAdvOutputLoad)/sizeof(oid)
        ...
        /* This item doesn't really belong here, this is easier for apcupsd -- KES */
	if (vars->name_length > sizeof(upsPhaseOutputPercentPower)/sizeof(oid)
	    ...
	    (*upsAdvOutput)->__upsPhaseOutputPercentPower = *vars->val.integer;
	    (*upsAdvOutput)->upsPhaseOutputPercentPower = &((*upsAdvOutput)->__upsPhaseOutputPercentPower);
	}
