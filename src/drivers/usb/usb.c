...
const struct s_known_info known_info[] = {
   ...
   {CI_NONE,                    0x00840001, P_ANY,     T_INDEX},    /* iName */
   {CI_VLINE,                   0x00840030, P_INPUT,   T_UNITS},    /* Line Voltage */
   {CI_VOUT,                    0x00840030, P_OUTPUT,  T_UNITS},    /* Output Voltage */
   {CI_VBATT,                   0x00840030, P_BATTERY, T_UNITS},    /* Battery Voltage */
   {CI_NONE,                    0x00840031, P_ANY,     T_UNITS},    /* Current */
   {CI_FREQ,                    0x00840032, P_OUTPUT,  T_UNITS},    /* Frequency */
   {CI_NONE,                    0x00840033, P_ANY,     T_UNITS},    /* ApparentPower */
   {CI_NONE,                    0x00840034, P_ANY,     T_UNITS},    /* ActivePower */
   {CI_LOAD,                    0x00840035, P_ANY,     T_UNITS},    /* PercentLoad */
   {CI_ITEMP,                   0x00840036, P_BATTERY, T_UNITS},    /* Temperature */
   {CI_HUMID,                   0x00840037, P_ANY,     T_UNITS},    /* Humidity */
   {CI_NOMBATTV,                0x00840040, P_ANY,     T_UNITS},    /* ConfigVoltage */
   {CI_NONE,                    0x00840042, P_ANY,     T_UNITS},    /* ConfigFrequency */
   {CI_NONE,                    0x00840043, P_ANY,     T_UNITS},    /* ConfigApparentPower */
   {CI_LTRANS,                  0x00840053, P_ANY,     T_UNITS},    /* LowVoltageTransfer */
   {CI_HTRANS,                  0x00840054, P_ANY,     T_UNITS},    /* HighVoltageTransfer */
   {CI_DelayBeforeReboot,       0x00840055, P_ANY,     T_UNITS},    /* DelayBeforeReboot */
   {CI_DWAKE,                   0x00840056, P_ANY,     T_UNITS},    /* DelayBeforeStartup */
   {CI_DelayBeforeShutdown,     0x00840057, P_ANY,     T_UNITS},    /* DelayBeforeShutdown */
   ...
   {CI_MANDAT,                  0x00850085, P_PWSUM,   T_DATE},     /* ManufactureDate */

   /*  Page 0x85 is the Battery System Page */
   {CI_RemCapLimit,             0x00850029, P_ANY,     T_CAPACITY}, /* RemCapLimit */
   {CI_RemTimeLimit,            0x0085002a, P_ANY,     T_UNITS},    /* RemTimeLimit */
   {CI_NONE,                    0x0085002c, P_ANY,     T_CAPACITY}, /* CapacityMode */
   {CI_BelowRemCapLimit,        0x00850042, P_ANY,     T_NONE},     /* BelowRemCapLimit */
   {CI_RemTimeLimitExpired,     0x00850043, P_ANY,     T_NONE},     /* RemTimeLimitExpired */
   {CI_Charging,                0x00850044, P_ANY,     T_NONE},     /* Charging */
   {CI_Discharging,             0x00850045, P_ANY,     T_NONE},     /* Discharging */
   {CI_NeedReplacement,         0x0085004b, P_ANY,     T_NONE},     /* NeedReplacement */
   {CI_BATTLEV,                 0x00850066, P_ANY,     T_CAPACITY}, /* RemainingCapacity */
   {CI_NONE,                    0x00850067, P_ANY,     T_CAPACITY}, /* FullChargeCapacity */
   {CI_RUNTIM,                  0x00850068, P_ANY,     T_UNITS},    /* RunTimeToEmpty */
   {CI_CycleCount,              0x0085006b, P_ANY,     T_NONE},
   {CI_BattPackLevel,           0x00850080, P_ANY,     T_NONE},     /* BattPackLevel */
   {CI_NONE,                    0x00850083, P_ANY,     T_CAPACITY}, /* DesignCapacity */
   {CI_BATTDAT,                 0x00850085, P_BATTERY, T_DATE},     /* ManufactureDate */
   {CI_IDEN,                    0x00850088, P_ANY,     T_INDEX},    /* iDeviceName */
   {CI_NONE,                    0x00850089, P_ANY,     T_INDEX},    /* iDeviceChemistry */
   {CI_NONE,                    0x0085008b, P_ANY,     T_NONE},     /* Rechargeable */
   {CI_WarningCapacityLimit,    0x0085008c, P_ANY,     T_CAPACITY}, /* WarningCapacityLimit */
   {CI_NONE,                    0x0085008d, P_ANY,     T_CAPACITY}, /* CapacityGranularity1 */
